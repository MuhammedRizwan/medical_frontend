...
export default function Sidebar() {
  ...
  <aside className="fixed top-0 left-0 z-30 w-20 md:w-64 h-screen bg-white shadow-md flex flex-col justify-between py-2 md:py-5 px-4 border-r-2 border-gray-300">
      <div>
        <div className="mb-7">
         <h1 className="text-blue-600 text-xs md:text-2xl font-medium leading-tight">
          life support <br />
          <div className="flex text-xs md:text-2xl font-medium tracking-wide">
            learning 
            <div>
              <p className='hidden md:text-xs'>powered by</p>
              <p className='hidden md:text-xs'>Duty Doctor</p>
            </div>
          </div>
        </h1>
        </div>
